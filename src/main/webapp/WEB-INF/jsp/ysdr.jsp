...
<form action="#" id="form1" method="post">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" style="outline:none;text-align:center; position: absolute; bottom:0.5%;right:4.5%;height:30px;" onclick="submitForm()"><input class="button1" type="button" id="button" value="预算结果" onclick="check()" style="border:0px white solid;background:transparent;outline:none;cursor: pointer;"/></a>
