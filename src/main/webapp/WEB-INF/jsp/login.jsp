...
<body style="background-image: url(/static/img/background.jpg);background-repeat: no-repeat;background-size:cover; ">
<p style="position: absolute;top:10%;left:36%;font-size: 400%;color:black;">项目预算管理系统</p>
<div style="background: #e0ecff;display:inline-block;width:400px;height:200px; position: relative;left: 40%;top: 30%; border-radius: 15px;box-shadow:10px 10px 10px gray ;">
    <br>
    <form style="height:500px; line-height:50px;position: relative;left:10%;" action="userLogin" method="post">
        ...
        <br>
        密码<input type="password" style="position: relative;;left:5%;" name="upass" id="upass"/>
        <br>
